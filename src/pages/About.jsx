        ...
        <Container>
            <Row>
                ...
                <Card>
                    <h1>A propos </h1>
                    <Card.Body>
                        <p> Bienvenue dans notre restaurant mexicain, où l'authenticité et la saveur se rencontrent pour créer une
                        ...
                        <p>
                            ...
                            expérience culinaire authentique et chaleureuse dans une ambiance conviviale et accueillante.
                        </p>
                        <p> 
                            ¡Buen provecho!
                        </p>
